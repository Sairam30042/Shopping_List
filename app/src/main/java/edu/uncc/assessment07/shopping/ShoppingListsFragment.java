...
public class ShoppingListsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listenerRegistration = FirebaseFirestore.getInstance().collection("shopping_list").whereEqualTo("ownerId", FirebaseAuth.getInstance().getCurrentUser().getUid()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        class ShopListsViewHolder extends RecyclerView.ViewHolder{
            ...
            public void deleteFirstItem(ArrayList<ShoppingListItem> items){
                if(items.size() > 0 ){
                    ...
                    db.collection("shopping_list").document(mShoppingList.getDocId()).collection("shopping_list_item").document(item.getDocId()).delete()
                    ...
                    FirebaseFirestore db= FirebaseFirestore.getInstance();
                    db.collection("shopping_list").document(mShoppingList.getDocId()).delete();
                }
            }
            public void setupUI(ShoppingList shoppingList){
                ...
                mBinding.imageViewDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseFirestore db = FirebaseFirestore.getInstance();
                        db.collection("shopping_list").document(mShoppingList.getDocId()).collection("shopping_list_item")
                                .get()
