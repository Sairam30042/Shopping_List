...
public class ShoppingListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listenerRegistration = FirebaseFirestore.getInstance().collection("shopping_list").document(mShoppingList.getDocId()).collection("shopping_list_item").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            ...
            public void setupUI(ShoppingListItem shoppingListItem){
                ...
                mBinding.imageViewMinus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        updateData.put("quantity", mShoppingListItem.quantity-1);
                        FirebaseFirestore.getInstance().collection("shopping_list").document(mShoppingList.getDocId()).collection("shopping_list_item").document(mShoppingListItem.getDocId()).update(updateData);
                    }
                        else{
                            FirebaseFirestore db = FirebaseFirestore.getInstance();
                            db.collection("shopping_list").document(mShoppingList.getDocId()).collection("shopping_list_item").document(mShoppingListItem.getDocId()).delete()
